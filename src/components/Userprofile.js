...
const Userprofile = () => {
    ...
    const getData=async()=>{
        ...
        const response1=await fetch(`${host}/api/user-info/userdata/${id}`,{
            method:"GET",
            headers:{
                'auth-token':localStorage.getItem("token"),
                'Content-type':'application/json',
      ...
      <div className="col-lg-4 card-profile">
        {
          data.map((datas)=>{
            return(
              <Userprofileitem key={datas._id} datas={datas}/>
            )
          })
        }
      </div>
                          ...
                          <div className="card-body p-3">
                            <ul className="list-inline p-0 m-0">
                              <li className="mb-2 d-flex">
                                <span><i className="lab la-facebook-f icon-text-primary font-size-20 mr-3" /></span>
                                <p className="mb-0 line-height">fb.me/nataliedawson</p>
                              </li>
                              <li className="mb-2 d-flex">
                                <span><i className="lab la-twitter icon-text-info font-size-20 mr-3" /></span>
                                <p className="mb-0 line-height">@nataliedawson</p>
                              </li>
                              <li className=" d-flex">
                                <span><i className="lab la-instagram  icon-text-danger font-size-20 mr-3" /></span>
